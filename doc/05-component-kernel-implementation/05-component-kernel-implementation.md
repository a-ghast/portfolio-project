...
PatientPanel1 will be represented by an ArrayList that will contain each individual Patient object. Patient1 is represented by two Strings, name and pcp, and an ArrayList of String, dates. The list makes it easy to add and remove items, get the length, and potentially iterate.
...
- Designed kernel implementation for PatientPanel component
